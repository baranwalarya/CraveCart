...
// import { signIn } from "../../../backend/controllers/auth.controllers";
...
function SignUp() {
  ...
  return (
    ...
    {{backgroundColor: bgColor}}>
      <div
  className="bg-white rounded-3xl shadow-lg w-full max-w-[340px]
        sm:max-w-[380px] p-6 sm:p-7 border-[1px]"
        style={{ border: `1px solid ${bordercolor}` 
        }}>
        <h1 className={`text-2xl font-bold mb-2`} style={{color:primaryColor}}>CraveCart</h1>
        ...
        <div className="mb-4">
          ...
          <input type="text" className="w-full border rounded-lg px-3 py-2 focus:outline-none  " placeholder="Enter your mobile no." style={{ border:`1px solid ${bordercolor}`}} onChange={(e)=>setMobile(e.target.value)} value={mobile} required/>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
             ...
             />
               <button type="button" className="absolute right-3 cursor-pointer top-[14px] text-gray-500" onClick={() => setShowPassword(prev=>!prev)}>{!showPassword? <FaEye />:<FaEyeSlash />}
               </button>
          </div>
        ...
        <button className={`w-full font-semibold rounded-lg  py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleSignUp} disabled={loading}>
