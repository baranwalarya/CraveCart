...
function CreateEditShop() {
    ...
    return (
        <div className="flex justify-center flex-col items-center 
            ...
            <div className="max-w-lg w-full bg-white shadow-xl      rounded-2xl p-4 border border-orange-100 mt-15 ml-9 mr-9">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <button className="w-full bg-[#ff4d2d] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-orange-600 hover:shadow-lg transition-all duration-200 cursor-pointer" disabled={loading}>{loading?<ClipLoader size={20} color="whi"/>:"Save"}</button>
                </form>
            </div>
