        ...
        {currentOrder?.shopOrders?.map((shopOrder,index)=>(
            <div className='bg-white p-4 rounded-2xl shadow-md border border-orange-100 space-y-4' key={index}>
                <div>
                    ...
                    <p className='font-semibold'><span>Items:</span> {shopOrder.shopOrderItems?.map(i=>i.name).join(",")}
                    </p>
                ...
                {shopOrder.status!="delivered" ? <>
                    ...
                    <div className='text-sm text-gray-700'>
                        ...
                        <p className='font-semibold'><span>Delivery Boy Contact: </span>{shopOrder.assignedDeliveryBoy.mobile}</p>
