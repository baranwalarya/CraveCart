    ...
    return(
        <div className="w-full min-h-screen bg-[#fff9f6] flex flex-col items-center">
            ...
            <div className="flex justify-center items-center p-4 sm:p-6">
                <div className="w-full max-w-sm bg-white shadow-lg rounded-2xl p-3 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                    <div className="flex flex-col items-center text-center">
                        <FaUtensils className="text-[#ff4d2d] w-16 h-16 sm:w-15 sm:h-15 mb-4"/>
